...
const WhyChooseUs: React.FC = () => {
    ...
    const features = [
        ...
        { icon: <GlobeIcon />, title: 'Multi-Language Support', desc: 'Serve clients in their preferred language with our built-in translation and transliteration tools.' },
    ];
                        ...
                        <div className="relative rounded-2xl overflow-hidden" style={{ boxShadow: 'var(--shadow-xl)' }}>
                            ...
                            <div className="h-[350px] sm:h-[450px] flex items-center justify-center relative" style={{ background: 'var(--gradient-cta)' }}>
                                ...
                                <div className="relative z-10 text-center">
                                    ...
                                    <p className="text-white/80 text-lg font-semibold">Bank-Grade Security</p>
                                    <p className="text-white/60 text-sm mt-1">256-bit SSL Encryption</p>
                                </div>
                            </div>
                        </div>
                    </div>
